{
 gROOT->Reset();
  ...
  TH2S frame("frame","",10,3,7,10,0,250);
  frame.GetXaxis()->SetTitle("E* (MeV)");
  frame.GetYaxis()->SetTitle("Counts / 20 keV");
  ...
  TLatex tt;
  tt.SetTextSize(.07);
  tt.DrawLatex(5.3, 190,"^{7}Li#rightarrow#it{t}+#alpha");
  //TArrow arrow;
  //arrow.SetFillColor(1);
  //arrow.SetAngle(35);

  //arrow.DrawArrow(1.56,500,1.56,400,.02);
  //arrow.DrawArrow(2.1,500,2.1,400,.02);
  //arrow.DrawArrow(3.05,650,3.05,550,.02);
  //arrow.DrawArrow(4.35,500,4.35,400,.02);

  //tt.DrawLatex(4.23,512,"4^{-}");
  //tt.DrawLatex(2.90,682,"3^{-}");
  //tt.DrawLatex(2.,512,"1^{-}");
  //tt.DrawLatex(1.42,512,"2^{-}");
 
  string printname = "Ex_7Li_ta.png";
